...
def render(surface, qr_part: str) -> None:
    render_text_centered(surface, "Scan QR", (DISPLAY_WIDTH // 2, 12), size=17, color=(100, 255, 150))
    render_qr(surface, qr_part, center=(DISPLAY_WIDTH // 2, DISPLAY_HEIGHT // 2 + 8), size=QR_DISPLAY_SIZE, error_correction="M",border=2)
